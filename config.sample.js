module.exports = {
  /*
    ...
    unless they have the token chibisafe provides you with.
  ...
  */
  ...
  /*
    ...
    since base chibisafe v3 do not have usergroups system.
  ...
  */
  ...
  /*
    Here you can decide if you want chibisafe to serve the files or if you prefer doing so via nginx.
    ...
    If you set it to `true`, the uploaded files will be located after the host like:
      https://chibisafe.moe/yourFile.jpg
    ...
    downloads in. This also gives you the ability to serve them, for example, like this:
      https://files.chibisafe.moe/yourFile.jpg
  ...
  */
  ...
  /*
    If you are serving your files with a different domain than your chibisafe homepage,
    then fill this option with the actual domain for your chibisafe homepage.
    This will be used for Open Graph tags and wherever chibisafe need to link to internal pages.
  ...
  */
  ...
  /*
    ...
    You may even add or remove pages while chibisafe is running.
  */
  pages: ['home', 'auth', 'dashboard', 'faq'],

  /*
    This will load public/libs/cookieconsent/cookieconsent.min.{css,js} on homepage (configured from home.js).
    You may use this if you have some specific needs, since chibisafe by itself will not use Cookies at all.
  ...
  */
  ...
  /*
    ...
    to instead use own http server (nginx, etc.) in front of chibisafe and configure from there.
  ...
  */
  cloudflare: {
    ...
    */
    ...
    /*
      ...
      API token configuration example: https://github.com/BobbyWibowo/chibisafe/pull/216#issue-440389284.
  ...
  /*
    ...
    Please consult the relevant codes in chibisafe.js to learn the specifics.
    ...
    chibisafe will automatically call Cloudflare API to purge cache of the relevant frontend pages.
  */
  cacheControl: false,
